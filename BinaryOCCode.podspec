...
Pod::Spec.new do |s|
  s.name             = 'BinaryOCCode'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BinaryOCCode.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhangqian/BinaryOCCode'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangqian' => 'zhangqian@jlife.vip' }
  s.source           = { :git => 'https://github.com/zhangqian/BinaryOCCode.git', :tag => s.version.to_s }
